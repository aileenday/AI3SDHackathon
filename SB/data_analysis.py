...
big_training_dataset = pd.read_csv('/Users/stevenbennett/Documents/AI3SD_Hackathon/LargerDataset/combined_dataset_without_pubchem.csv')
...
scatter = ax.scatter(res[:,0], res[:,1], c=logS)
fig.colorbar(scatter, ax=ax)
fig.savefig('PCA_LargeData.png', facecolor=fig.get_facecolor())
...
ax.scatter(original_predictions, logS_original)
ax.set_xlabel('Original logS / M')
ax.set_ylabel('Predicted logS / M')
model_correlation.savefig('KRRLinear.png')
